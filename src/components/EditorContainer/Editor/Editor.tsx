...
const Editor: React.FC<EditorProps> = ({ blocks, setBlocks, linkMeta }) => {
  ...
  return (
    <div
      className="mt-4 border border-[#E7F1E9] rounded h-full w-full relative overflow-hidden flex flex-col"
      ref={editorRef}
    >
      <div className="border-[#E7F1E9] border-b py-6 mb-[22px]" />
      <input
        placeholder="Add Post Title"
        className="text-2xl px-4 font-bold appearance-none border-none focus:outline-none placeholder:font-bold placeholder:text-2xl placeholder:text-primary bg-transparent"
      />
      <div className="flex border border-[#E7F1E9] py-3 rounded-[5px] items-center px-3 my-4 w-fit mx-4">
        <div
      ...
      <div className="flex-grow overflow-auto relative mx-4">
        ...
        {hasTyped && (
          <div
            className="sticky mb-4 bg-[#E7F1E9] rounded-full w-[32px] h-[32px] flex items-center justify-center cursor-pointer"
            style={{ left: "0px" }}
        ...
        {showDropdown && (
          <div
            className="absolute bg-white border border-[#E7F1E9] rounded-md shadow-[0px 1px 4px #00000014] p-2 w-[277px] h-[181px]"
            style={{ left: "10px" }}
          >
      ...
      <div className="sticky flex bottom-0 left-0 right-0 px-4 py-2 bg-white border-t border-[#E7F1E9]">
        <p className="ml-auto text-sm text-gray-500">{`${wordCount}/${maxWords} words`}</p>
      </div>
    </div>
  );
};
