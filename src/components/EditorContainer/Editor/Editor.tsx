  ...
  return (
    <div className="mt-4 overflow-auto" ref={editorRef}>
      <div className="flex border border-[#E7F1E9] h-[40px] rounded-[5px] items-center px-3 mb-4 w-fit">
        <div
          className="text-[#343E37] text-xs font-normal flex gap-[18px] items-center cursor-pointer relative"
      ...
      {blocks.map((block, index) => {
        if (block.type === "text") {
          return (
            <div
              key={index}
              className="mb-2 bg-transparent border-none focus:outline-none resize-none text-[#343E37] text-sm font-normal"
              contentEditable
          ...
          return (
            <div key={index} className="relative group mb-4">
              ...
              <a
                ...
                className="block text-[#9DC7A9] underline"
              >
      ...
      {showParagraphDropdown && (
        <div className="absolute top-[100px] left-0 z-10 bg-white border border-gray-300 rounded-md shadow-md p-2">
          <p
            className="cursor-pointer p-2 hover:bg-[#FAFAFA] text-[#343E37] text-xs font-normal"
      ...
      {showDropdown && (
        <div
          ...
          style={{ left: "10px" }}
        >
          <p className="text-[#333333] font-normal text-[10px] mb-2">EMBEDS</p>
          <div
            className="py-2 cursor-pointer flex items-start gap-2 hover:bg-[#F7FCF8] focus:bg-[#F7FCF8]"
            onClick={() => {
              handleTogglePictureModal();
          ...
          >
            ...
            <div>
              ...
              <p className="text-[8px] text-[#343E37] text-normal">Jpeg, png</p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[8px] text-[#343E37] text-normal">
